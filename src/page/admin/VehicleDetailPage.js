...
export default function VehicleDetailPage() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${Http.HOST}/api/user/vehicle/vehicle-detail/${vehicle_id}`, {
    ...
    <div className="container-fluid pt-4 px-4 mb-3">
      <div className="row g-4">
        <div className="col-sm-12 col-xl-12 header-body">
          <div
            className="container-fluid pb-2 pt-2 px-4 bg-glass rounded"
              ...
              >
                ...
                <div className="mt-3">
                  ...
                  <p className="text-dark">
                    {DateUtil.IOStringToDate(vehicle.createdAt)}
                  </p>
                </div>
                <div className="mt-3">
                  <p className={"title-field-driver-registration rounded"}>
                      ...
                      <img
                        onClick={() =>
                          UseViewLargeImg(
                            String(
                              Http.RESOURCE_HOST +
                                vehicle.back_vehicle_registration_certificate
                            )
                          )
                        }
                        src={String(
                      ...
                      <img
                        onClick={() =>
                          UseViewLargeImg(
                            String(
                              Http.RESOURCE_HOST +
                                vehicle.front_vehicle_registration_certificate
                            )
                          )
                        }
                        src={String(
                    ...
                    <div>
                      <img
                        onClick={() =>
                          UseViewLargeImg(
                            String(
                              Http.RESOURCE_HOST + vehicle.front_driving_license
                            )
                          )
                        }
                        src={String(
                    ...
                    <div>
                      <img
                        onClick={() =>
                          UseViewLargeImg(
                            String(
                              Http.RESOURCE_HOST + vehicle.back_driving_license
                            )
                          )
                        }
                        src={String(
                ...
                <Stack direction={"row"} spacing={2}>
                  <div>
                    ...
                    <img
                      onClick={() =>
                        UseViewLargeImg(
                          String(Http.RESOURCE_HOST + vehicle.front_vehicle)
                        )
                      }
                  ...
                  <div>
                    ...
                    <img
                      onClick={() =>
                        UseViewLargeImg(
                          String(Http.RESOURCE_HOST + vehicle.back_vehicle)
                        )
                      }
                      src={String(Http.RESOURCE_HOST + vehicle.back_vehicle)}
                      alt="id card"
                      data-bs-toggle="modal"
                      data-bs-target="#image_larger_modal"
                      width={"100%"}
                ...
                <Stack direction={"row"} spacing={2} className={"mt-5"}>
                  <div>
                    ...
                    <img
                      onClick={() =>
                        UseViewLargeImg(
                          String(Http.RESOURCE_HOST + vehicle.left_vehicle)
                        )
                      }
                      src={String(Http.RESOURCE_HOST + vehicle.back_vehicle)}
                      alt="id card"
                  ...
                  <div>
                    ...
                    <img
                      onClick={() =>
                        UseViewLargeImg(
                          String(Http.RESOURCE_HOST + vehicle.right_vehicle)
                        )
                      }
                      src={String(Http.RESOURCE_HOST + vehicle.right_vehicle)}
                      alt="id card"
                      data-bs-toggle="modal"
                      data-bs-target="#image_larger_modal"
                      width={"100%"}
